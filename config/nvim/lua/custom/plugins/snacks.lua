return {
  ...
  keys = {
    ...
    { '<leader>fi',  function() Snacks.picker.files({ ignored = true }) end, desc = '[F]ind files ([i]ncl. ignored)' },
    ...
    { '<leader>gi',  function() Snacks.picker.grep({ ignored = true }) end, desc = '[G]rep ([i]ncl. ignored)' },
