return {
  ...
  opts = {
    ...
    format_on_save = function(bufnr)
      ...
      return {
        -- Pint cold-starts can blow past the default 500ms on large Laravel
        -- apps, and with notify_on_error = false the save would silently
        -- complete unformatted.
        timeout_ms = vim.bo[bufnr].filetype == "php" and 3000 or 500,
